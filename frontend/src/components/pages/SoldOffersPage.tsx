...
import style from "../../styles/SoldOffersPage.module.css"

const SoldOffersPage= () => {
    ...
    async function fetchSoldOffers() {
        try {
            const fetchedSoldOffers = await OffersApi.fetchSoldOffers() 
            console.log(fetchedSoldOffers)
    ...
    const allOffersGrid = soldOffers.map((offer:SoldOffer,index:any)=>{
