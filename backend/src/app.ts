...
app.use(cors({
  origin: [env.FRONTEND_SITE_URL], // Frontend adresi - [env.FRONTEND_SITE_URL] - "https://docker-3g3-frontend.onrender.com" - "https://threeg3.vercel.app" - "http://localhost:3000"
  credentials: true
}))
